...
1. Navigate to [Report a Vulnerability](https://github.com/metadatastician/f19-stealth-glider/security/advisories/new)
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/metadatastician/f19-stealth-glider/security/advisories)
...
- [Security Advisories](https://github.com/metadatastician/f19-stealth-glider/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/metadatastician/f19-stealth-glider/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/metadatastician/f19-stealth-glider/discussions) |
...
*Thank you for helping keep F19 Stealth Glider and its users safe.* 🛡️
